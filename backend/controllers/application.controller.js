...
return res.status(200).json({message:"Application found",application,success:true});
}catch(err){
    console.log(err);
...
//admin see how many user applied
...
try{
    ...
    //find application by appcation id
