            ...
            <div className='flex item-center justify-center max-w-7xl mx-auto'>
                <form onSubmit={submitHandler} className='w-1/2 border border-gray-200 rounded-md p-4 my-10'>
                   ...
                   <div className='my-2'>
                    ...
                    {
                        loading?<Button className='w-full m-4'><Loader2 className='mr-2 h-4 w-4 animate-spin'/>Please wait</Button>:<Button type="Submit" className='w-full m-4'>Login</Button>
                    }
